...
type Patient struct {
	...
	PatientCode           string         `gorm:"unique;not null;size:20;index" json:"patient_code" validate:"required"`
	...
	EmergencyContactPhone string         `gorm:"size:15" json:"emergency_contact_phone,omitempty"`
	InsuranceNumber       string         `gorm:"size:50" json:"insurance_number,omitempty"`
